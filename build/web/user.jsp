        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <input type="hidden" class="form-control" value="<%=rs.getString("id") %>" disabled>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
...
conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/itsupport","root","");
 request.getSession(false);
    String usernamea=(String)session.getAttribute("username");
         Statement st1=null;
         String sql1="select * from chat where send_name='"+usernamea+"'";
         st1=conn.createStatement();
         ResultSet rs1=null;
         rs1=st1.executeQuery(sql1);
         while(rs1.next()){
        %>
        <div class="chat-bubble you"><%=rs1.getString("message") %></div>
...
conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/itsupport","root","");
         ...
         while(rs2.next()){
        %>
         <div class="chat-bubble me"><%=rs2.getString("message")%></div>
         <div class="chat-start">Monday, 1:27 PM</div>
         <%}%>
        
        
    </div>
     <form action="bot.jsp" method="post">           
